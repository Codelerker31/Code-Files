...
def login():
	if user_name.get()=="" or password.get()=="":
		...
		try:
			con = pymysql.connect(host="localhost",user="root",password="",database="database1")
			cur = con.cursor()
...
def signup():
		...
		if first_name.get()=="" or last_name.get()=="" or age.get()=="" or city.get()=="" or add.get()=="" or user_name.get()=="" or password.get()=="" or very_pass.get()=="":
			...
			try:
				...
				if row!=None:
					...
					cur.execute("insert into user_information(first_name,last_name,age,gender,city,address,username,password,id1) values(%s,%s,%s,%s,%s,%s,%s,%s,%s)",
						(
						first_name.get(),
						last_name.get(),
						age.get(),
	...
	winsignup = Tk()
	winsignup.title("Payroll Management System")
	...
	account_no = Label(winsignup, text= "Account No. :" , font='Verdana 10 bold')
	account_no.place(x=80,y=290)

	bank = Label(winsignup, text= "Bank:" , font='Verdana 10 bold')
	bank.place(x=80,y=290)
	...
	id1 = Label(winsignup, text= "ID :" , font='Verdana 10 bold')
	id1.place(x=80,y=400)
	...
	Radio_button_male = ttk.Radiobutton(winsignup,text='Male', value="Male", variable = var).place(x= 200 , y= 190)
	Radio_button_female = ttk.Radiobutton(winsignup,text='Female', value="Female", variable = var).place(x= 200 , y= 210)
	...
	id1 = Entry(winsignup, width=40, textvariable = id1)
	id1.place(x=200 , y=400)
...
username = Label(win, text= "ID :" , font='Verdana 10 bold')
...
sign_up_btn = Button(win , text="Register", font='Verdana 10 bold', command = signup )
sign_up_btn.place(x=260 , y =293)
